...
export type RelationsQuery = { __typename?: 'Query', relations?: { __typename?: 'ApplicantIndividualCompanyRelationPaginator', data: Array<{ __typename?: 'ApplicantIndividualCompanyRelation', id: string, name: string }> } | null };

export type PositionsQueryVariables = Exact<{ [key: string]: never; }>;


export type PositionsQuery = { __typename?: 'Query', positions?: { __typename?: 'ApplicantIndividualCompanyPositionPaginator', data: Array<{ __typename?: 'ApplicantIndividualCompanyPosition', id: string, name: string }> } | null };
...
export function useRelationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RelationsQuery, RelationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
export const PositionsDocument = gql`
    query positions {
  positions: applicantIndividualCompanyPositions {
    data {
      id
      name
    }
